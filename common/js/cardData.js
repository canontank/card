var cardValueArray = new Array(
    ...
    new Array('신세계5', 'SSG 10만, 지마켓/옥션 25만'),
    new Array('이마트5', 'SSG 10만, 지마켓/옥션 25만'),
    new Array('지엔미', 'SSG 10만'),
    new Array('애니패스', 'SSG 10만'),
    new Array('CMA', 'SSG 10만'),
